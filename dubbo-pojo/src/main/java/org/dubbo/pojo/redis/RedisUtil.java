...
/**
 * Created by fanglei on 2017/12/14.
 */
...
//     * @param by 要减少几(小于0)
    ...
    public List<Object> hmget(String key,Collection<Object> items){
//        Object[] objs = new Object[items.size()];
//        for(Object i : items){
//            objs[i] = items.get(i);hmget()
//        }
//        return redisTemplate.getConnectionFactory().getConnection().hMGet(key,items)
  ...
  /**  public boolean lSet(String key, List<Object> value) {
    ...
    public boolean zAdd(String key,String value,double source) {
        try {
            boolean result = redisTemplate.opsForZSet().add(key,value,source);
            return result;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
